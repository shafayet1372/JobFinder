...
export default function SalaryFilter() {
 ...
 const {sortinType}=useSelector(state=>state.jobs)

 const sortingHandler=(e)=>{
 dispatch(setSortingType(e.target.value))
 }
  return  <select id="lws-sort" name="sort" autocomplete="sort" className="flex-1" value={sortinType} onChange={sortingHandler}>
